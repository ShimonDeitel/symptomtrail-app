...
final class SymptomtrailUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["unlockProButton"].waitForExistence(timeout: 5) || app.staticTexts["Symptomtrail Pro"].waitForExistence(timeout: 5))
    }
